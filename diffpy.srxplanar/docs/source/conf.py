...
# abbreviations
ab_authors = "Xiahao Yang, Simon Billinge, Billinge Group Members"
...
modindex_common_prefix = ["diffpy.srxplanar"]
...
basename = "diffpy.srxplanar".replace(" ", "").replace(".", "")
...
latex_documents = [
    (
        "index",
        "diffpy.srxplanar.tex",
        "diffpy.srxplanar Documentation",
        ab_authors,
        "manual",
    ),
]
